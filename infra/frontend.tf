...
resource "aws_cloudfront_distribution" "frontend" {
  ...
  # ALB origin for WebSocket transcription service
  origin {
    domain_name = aws_lb.transcription.dns_name
    origin_id   = "ALB-transcription"
  ...
  # WebSocket behavior — routes /ws to the ALB
  ordered_cache_behavior {
    path_pattern           = "/ws"
    allowed_methods        = ["GET", "HEAD", "OPTIONS", "PUT", "POST", "PATCH", "DELETE"]
    cached_methods         = ["GET", "HEAD"]
    target_origin_id       = "ALB-transcription"
